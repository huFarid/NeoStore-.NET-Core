    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Category 1", "Transportation" },
                    { 2, "Category 2", "Digital Products" },
                    { 3, "Category 3", "Educational" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Safe and Effordable", 1, "Car 1" },
                    { 2, "Classic", 2, "Car 2" },
                    { 3, "Fast", 3, "Car 3" },
                    { 4, "Last Generation", 4, "Phone 1" },
                    { 5, "Last Generation", 5, "Phone 2" },
                    { 6, "Last Generation", 6, "Phone 3" },
                    { 7, "Differential Equations", 7, "Book 1" },
                    { 8, "Physics", 8, "Book 2" }
                });
